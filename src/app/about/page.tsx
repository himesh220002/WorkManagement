...
export default function AboutPage() {
  return (
    <main className="flex flex-col min-w-0 p-6 flex-1 flex justify-center items-start">
      <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-sm p-10 w-full max-w-4xl rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 mt-10">
        <div className="flex items-center justify-between mb-8">
          <h1 className=" text-3xl font-bold text-gray-900 dark:text-gray-100 flex items-center gap-3">
            <i className="fa-solid fa-sparkles text-indigo-500"></i> About TaskFlow PM
          </h1>
          <Link href="/exec/dashboard" className="px-4 py-2 bg-gray-50 dark:bg-gray-700/50 text-gray-900 dark:text-gray-100 rounded-lg hover:bg-white/10 transition-colors border border-gray-200 dark:border-gray-700 flex items-center gap-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white/5 border border-gray-200 dark:border-gray-700 p-6 rounded-lg transition-transform hover:-translate-y-1">
